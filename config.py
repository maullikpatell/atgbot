...
SOURCE_CODE = os.environ.get("SOURCE_CODE", "https://github.com/technicalatg/atgbot") # for upstream repo
...
BASE_SITE = os.environ.get("BASE_SITE", "atglinks.in") # your shortener site domain
