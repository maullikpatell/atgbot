...
~ `mdlink` - Change all the links of the post to your MDisk account first and then short to ATG link.

~ `shortener` - Short all the links of the post to ATG link directly.
